        ...
        <div id="container">
            <div id="header-wp">
                <div id="head-top" class="clearfix">
                    <div class="wp-inner">
                        <a style="visibility: hidden" href="" title="" id="payment-link" class="fl-left">Hình thức thanh toán</a>
                        <div id="main-menu-wp" class="fl-right">
                            <ul id="main-menu" class="clearfix">
                                ...
                                @foreach ($pages as $page)
                                    <li>
                                        <a href="{{ route('post.all', $page->id) }}" title="">{{ $page->name }}</a>
                                    </li>
                                @endforeach
                                <li>
