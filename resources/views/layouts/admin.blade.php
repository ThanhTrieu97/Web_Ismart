...
<body>
            ...
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{ $module_active == 'page' ? 'active' : '' }}">
                        <a href="{{ url('admin/page/list_page') }}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="far fa-folder"></i>
                            </div>
                            Trang
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ url('admin/page/add_page') }}">Thêm mới</a></li>
                            <li><a href="{{ url('admin/page/list_page') }}">Danh sách</a></li>
                        </ul>
                    </li>
                    <li class="nav-link {{ $module_active == 'post' ? 'active' : '' }}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ url('admin/post/add_cat') }}">Thêm mới danh mục</a></li>
                            <li><a href="{{ url('admin/post/list_cat') }}">Danh mục bài viết</a></li>
                        </ul>
                    </li>
                    <li class="nav-link {{ $module_active == 'product' ? 'active' : '' }}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ url('admin/product/add_cat') }}">Thêm mới danh mục</a></li>
                            <li><a href="{{ url('admin/product/list_cat') }}">Danh sách danh mục</a></li>
                            <li><a href="{{ url('admin/product/add_image') }}">Thêm ảnh slider của sản phẩm</a></li>
                            <li><a href="{{ url('admin/product/list_image') }}">Danh sách ảnh slider</a></li>
                            <li><a href="{{ url('admin/product/add_product_type') }}">Thêm loại sản phẩm</a></li>
                            <li><a href="{{ url('admin/product/list_product_type') }}">Danh sách loại sản phẩm</a></li>
                    ...
                    <li class="nav-link {{ $module_active == 'role' ? 'active' : '' }}">
                        <a href="{{ url('admin/role/list_permission') }}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="far fa-folder"></i>
                            </div>
                            Phân quyền
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ url('admin/role/add_permission') }}">Thêm quyền user</a></li>
                            <li><a href="{{ url('admin/role/list_permission') }}">Danh sách quyền user</a></li>
                        </ul>
                    </li>
    ...
    <script src="https://cdn.tiny.cloud/1/rgzkie9m99cmp496xzpy8lrj4b77a9u74khehtq2vacehiwa/tinymce/5/tinymce.min.js"
        referrerpolicy="origin"></script>
    <script>
        var editor_config = {
            path_absolute: "http://localhost:8080/unitop.vn/laravelpro/unimart/",
            selector: 'textarea',
            relative_urls: false,
            plugins: [
    ...
    <script>
        $(document).ready(function() {
            $("table").on('click', '#page-detail', function() {
