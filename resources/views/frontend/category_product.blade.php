            ...
            <div class="main-content fl-right">
                <div class="section" id="list-product-wp">
                    <div class="section-head clearfix">
                        <h3 class="section-title fl-left">{{ $list->name }} <span style="font-size: 20px;font-family: none;">({{ $count }} sản phẩm)</span></h3>
                    ...
                    <div class="section-detail">
                        <ul class="list-item clearfix">
                            ...
                            @endforeach
                            @else
                                <p style="font-size: 16px; margin-left: 143px; color: red; font-weight: bold;">Hiện không có sản phẩm nào trong mục này!</p>
                            @endif
                        </ul>
                    </div>
                </div>
