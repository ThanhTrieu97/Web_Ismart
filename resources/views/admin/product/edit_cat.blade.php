        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('product_cat_update', $product_cat->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="slug" id="slug" value="{{ $product_cat->slug }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="parent_id" name="parent_id">
                                    <option value="{{ $product_cat->parent_id }}">Chọn danh mục</option>
                                    @php
